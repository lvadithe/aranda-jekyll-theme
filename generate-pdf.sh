...
# list all files in the _page directory sorting by numerical order starting from second field separated by "/"
...
do
    ...
    sed -i 's/\/en\///g' "$line" # Remove /en/ prefix in the file itself
